...
from transformers.utils import ModelOutput, auto_docstring, is_vision_available, logging, torch_int
...
class Owlv2AttentionFA2(nn.Module):
...
class Owlv2EncoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Owlv2Config):
        super().__init__()
        self.embed_dim = config.hidden_size
        self.self_attn = Owlv2AttentionFA2(config)#FA2
